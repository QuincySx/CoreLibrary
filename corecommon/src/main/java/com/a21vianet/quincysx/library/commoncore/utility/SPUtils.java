...
public class SPUtils {
     ...
     */
    public SPUtils() {
        sp = ContentUtility.getContext().getSharedPreferences("app", Context.MODE_PRIVATE);
        editor = sp.edit();
        editor.apply();
    }
    ...
    public SPUtils(String spName) {
        sp = ContentUtility.getContext().getSharedPreferences(spName, Context.MODE_PRIVATE);
        editor = sp.edit();
        editor.apply();
    }
